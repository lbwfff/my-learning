...
model = AutoModelForSequenceClassification.from_pretrained("InstaDeepAI/nucleotide-transformer-v2-500m-multi-species", num_labels=num_labels_promoter, cache_dir=model_path,trust_remote_code=True)
...
plt.savefig('/scratch/lb4489/project/mttRNA/Aund_trainset/nucleotide-transformer_evaluation_metrics.png', dpi=300, bbox_inches='tight')
...
plt.savefig('/scratch/lb4489/project/mttRNA/Aund_trainset/nucleotide-transformer_Confusion.png', dpi=300, bbox_inches='tight')
...
plt.savefig('/scratch/lb4489/project/mttRNA/Aund_trainset/nucleotide-transformer_AUC.png', dpi=300, bbox_inches='tight')
...
plt.savefig('/scratch/lb4489/project/mttRNA/Aund_trainset/nucleotide-transformer_PRAUC.png', dpi=300, bbox_inches='tight')
